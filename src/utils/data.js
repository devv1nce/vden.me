...
export const SCHOOL_PROJECTS = [
  ...
  },
  {
    ...
    description: "An informative video exploring how dating apps, algorithms, AI companions, and digital beauty standards are reshaping modern dating culture[cite: 1].",
    tags: ["History", "Video", "Final Project"],
    type: "video",
